...
most of the people rows, the two structural inputs and the two
behavioural buttons of Application UI.
...
**`example/lib/src/showcase/`** is where the other 48 still are — the
