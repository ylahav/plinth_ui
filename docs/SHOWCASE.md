...
arrangements — plus the navbars, headers, most of the stats and the
first of the people rows of Application UI.
...
**`example/lib/src/showcase/`** is where the other 59 still are — the
